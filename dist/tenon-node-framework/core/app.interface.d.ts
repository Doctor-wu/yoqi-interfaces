...
export declare type tenonAppType = Koa<Koa.DefaultState, Koa.DefaultContext> & {
    start: () => Promise<any>;
    ...
    $controllers?: {
        [prop: string]: BaseController;
    };
    $services?: {
        [prop: string]: BaseService;
    };
    $mongoose?: Mongoose;
};
...
export declare type RequestNext = Koa.Next;
