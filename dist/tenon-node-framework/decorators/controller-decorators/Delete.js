...
function Delete(requestPath, requestOptions) {
    if (requestOptions === void 0) { requestOptions = {}; }
    var _a = requestOptions.params, paramsConfig = _a === void 0 ? {} : _a;
    return function deleteDecorator(target, propertyKey, descriptor) {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            if (!success) {
                                return [2 /*return*/, this.responseError(ctx, next)(errorCode, errorMsg)];
                            }
